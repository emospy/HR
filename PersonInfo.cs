...
namespace HR
{
	...
	public class formPersonalData : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.dataGridViewLanguages.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle1;
			...
			this.dataGridViewLanguages.DefaultCellStyle = dataGridViewCellStyle2;
			...
			this.dataGridViewLanguages.RowHeadersDefaultCellStyle = dataGridViewCellStyle3;
			...
			this.dataGridViewAssignment.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle4;
			...
			this.dataGridViewAssignment.DefaultCellStyle = dataGridViewCellStyle5;
			...
			this.dataGridViewAssignment.RowHeadersDefaultCellStyle = dataGridViewCellStyle6;
			...
			this.dataGridViewYears.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle7;
			...
			this.dataGridViewYears.DefaultCellStyle = dataGridViewCellStyle8;
			...
			this.dataGridViewYears.RowHeadersDefaultCellStyle = dataGridViewCellStyle9;
			...
			this.dataGridViewAbsence.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle10;
			...
			this.dataGridViewAbsence.DefaultCellStyle = dataGridViewCellStyle11;
			...
			this.dataGridViewAbsence.RowHeadersDefaultCellStyle = dataGridViewCellStyle12;
			...
			this.dataGridViewPenalties.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle13;
			...
			this.dataGridViewPenalties.DefaultCellStyle = dataGridViewCellStyle14;
			...
			this.dataGridViewPenalties.RowHeadersDefaultCellStyle = dataGridViewCellStyle15;
			...
			this.dataGridViewNotes.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle16;
			...
			this.dataGridViewNotes.DefaultCellStyle = dataGridViewCellStyle17;
			...
			this.dataGridViewNotes.RowHeadersDefaultCellStyle = dataGridViewCellStyle18;
			...
			this.dataGridViewAttestations.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle19;
			...
			this.dataGridViewAttestations.DefaultCellStyle = dataGridViewCellStyle20;
			...
			this.dataGridViewAttestations.RowHeadersDefaultCellStyle = dataGridViewCellStyle21;
			...
			this.dataGridViewFired.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle22;
			...
			this.dataGridViewFired.DefaultCellStyle = dataGridViewCellStyle23;
			...
			this.dataGridViewFired.RowHeadersDefaultCellStyle = dataGridViewCellStyle24;
			...
			this.dataGridViewEducations.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle25;
			...
			this.dataGridViewEducations.DefaultCellStyle = dataGridViewCellStyle26;
			...
			this.dataGridViewEducations.RowHeadersDefaultCellStyle = dataGridViewCellStyle27;
			...
			this.dataGridViewRang.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle28;
			...
			this.dataGridViewRang.DefaultCellStyle = dataGridViewCellStyle29;
			...
			this.dataGridViewRang.RowHeadersDefaultCellStyle = dataGridViewCellStyle30;
			...
			this.dataGridViewCards.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle31;
			...
			this.dataGridViewCards.DefaultCellStyle = dataGridViewCellStyle32;
			...
			this.dataGridViewCards.RowHeadersDefaultCellStyle = dataGridViewCellStyle33;
		...
		private void SaveAss()
		{
			...
			Dictionary<string, object> isactiveDict = new Dictionary<string, object>();
			Dictionary<string, object> notesDict = new Dictionary<string, object>();
			Dictionary<string, object> absenceDict = new Dictionary<string, object>();
			Dictionary<string, object> structureDict = new Dictionary<string, object>();

			if(this.comboBoxContract.SelectedText.StartsWith("Срочен"))
			{
				//this.CreateTemporaryContract();
			}

			this.ValidateAssignment(Dict);
			int checkres;
			bool IsValid = true;
			...
			Dict.Add("Exported", "0");
			Dict.Add("IsActive", "1");
			Dict.Add("ParentContractID", this.textBoxContractNumber.Text);
			Dict.Add("PrevAssignmentID", "0");

			//Prepare to add row to notes table here
			//notesDict.Add("Date", DataAction.ConvertDateToMySqlU(DateTime.Now, mainForm.DataBaseTypes));
			notesDict.Add("Date", DateTime.Now);
			notesDict.Add("Text", "Назначен на " + this.dateTimePickerAssignedAt.Text);
			notesDict.Add("Type", "Назначение");
			notesDict.Add("TypeDocument", this.comboBoxAssignReason.Text);
			notesDict.Add("Par", this.parent.ToString());
			...
			absenceDict.Add("Leftover", left.ToString());
			absenceDict.Add("Total", total.ToString());
			absenceDict.Add("Year", this.Year);
			absenceDict.Add("Parent", this.parent.ToString());

			string prostitute = this.mainform.nomenclaatureData.dtReasonAssignment.Rows[this.comboBoxAssignReason.SelectedIndex]["substitute"].ToString(); //проверява дали новата му назначение е като заместник
			if (prostitute != "1")
			{
				float staffchange = 0;
				staffchange = this.getWorkTimeStaff();

				structureDict.Add("free", "'free - " + staffchange.ToString());
				structureDict.Add("busy", "'busy + " + staffchange.ToString());
			}

			int id;
			id = this.dataAdapter.UniversalInsertParam(TableNames.PersonAssignment, Dict, "id", TransactionComnmand.BEGIN_TRANSACTION);
			if (id <= 0)
			{
				return;
			}
			...
			id = this.dataAdapter.UniversalInsertParam(TableNames.NotesTable, notesDict, "id", TransactionComnmand.USE_TRANSACTION);
			if (id <= 0)
			{
				return;
			}
			notesDict.Add("ID", id.ToString());

			//Just to be sure delete all from year_holiday table for this parent
			IsValid = this.dataAdapter.UniversalDelete(TableNames.YearHoliday, this.parent.ToString(), "parent", TransactionComnmand.USE_TRANSACTION);
			if (IsValid == false)
				return;

			id = this.dataAdapter.UniversalInsertParam(TableNames.YearHoliday, absenceDict, "id", TransactionComnmand.USE_TRANSACTION);
			if (id <= 0)
			{
				return;
			}
			absenceDict.Add("ID", id.ToString());

			IsValid = this.dataAdapter.UniversalUpdateObject(TableNames.FirmPersonal3, this.positionID.ToString(), structureDict, "id", TransactionComnmand.USE_TRANSACTION);
			if (IsValid == false)
				return;

			personDict.Add("nodeID", this.nodeID.ToString());
			IsValid = this.dataAdapter.UniversalUpdateParam(TableNames.Person, "id", personDict, this.parent.ToString(), TransactionComnmand.COMMIT_TRANSACTION);
			if (IsValid == false)
				return;

			this.AddDictToTable(absenceDict, this.dtYearHoliday);
			this.AddDictToTable(notesDict, this.dtNotes);
			this.dateTimePickerPostypilNa.Value = this.dateTimePickerAssignedAt.Value;

			this.AddDictToTable(Dict, this.dtAssignment);
		...
		private void SaveAddAss()
		{
			...
			DataView vuePrevAssignment = new DataView(this.dtAssignment, "isactive = 1", "id", DataViewRowState.CurrentRows);
			DataRow rowH = null; //row for the holliday table
			float staff = 0, oldstaff = 0;
			...
			{
				tesparse = int.TryParse(vuePrevAssignment[0]["positionid"].ToString(), out this.oldPositionID);

				staff = this.getWorkTimeStaff();

				tesstaff = float.TryParse(vuePrevAssignment[0]["staff"].ToString(), out oldstaff);
				...
				oldsubstitute = vuePrevAssignment[0]["substitute"].ToString(); //проверява дали новата му назначение е като заместник
			...
			{
				float staffchange = staff - oldstaff;
				if (staff > oldstaff)
				{
			...
			Dict.Add("Exported", "0");
			Dict.Add("IsActive", "1");
			Dict.Add("ParentContractID", vuePrevAssignment[0]["ParentContractID"].ToString());
			Dict.Add("PrevAssignmentID", vuePrevAssignment[0]["ID"].ToString());

			//Prepare to add row to notes table here
			notesDict.Add("Date", DateTime.Now);
			notesDict.Add("Text", "Сключил допълнително споразумение на " + this.dateTimePickerAssignedAt.Text);
			notesDict.Add("Type", "Споразумение");
			notesDict.Add("TypeDocument", this.comboBoxAssignReason.Text);
			notesDict.Add("Par", this.parent.ToString());
			...
			if (this.dtYearHoliday.Rows.Count > 0)
			{
				...
				if (rowH != null)
				{
					if ((int)rowH["Total"] != new_total) //Ако съществува проверява дали ще има някаква корекция върху отпуските
					{
						...
						absenceDict.Add("Leftover", left.ToString());
						absenceDict.Add("Total", new_total.ToString());
						absenceDict.Add("Year", this.Year);
						absenceDict.Add("Parent", this.parent.ToString());
					}
				}
			...
			int id;
			id = this.dataAdapter.UniversalInsertParam(TableNames.PersonAssignment, Dict, "id", TransactionComnmand.BEGIN_TRANSACTION);
			//id = this.dataAdapter.UniversalInsertParam(TableNames.PersonAssignment, Dict, TransactionComnmand.BEGIN_TRANSACTION);
			if (id <= 0)
			{
				return;
			}
			...
			isactiveDict.Add("isactive", "0");
			IsValid = this.dataAdapter.UniversalUpdateParam(TableNames.PersonAssignment, "id", isactiveDict, vuePrevAssignment[0]["id"].ToString(), TransactionComnmand.USE_TRANSACTION);
			vuePrevAssignment[0]["isactive"] = 0;
			if (IsValid == false)
			{
				return;
			}
			...
			if (rowH != null && absenceDict.Count > 0)
			{
				IsValid = this.dataAdapter.UniversalUpdateParam(TableNames.YearHoliday, "id", absenceDict, rowH["id"].ToString(), TransactionComnmand.USE_TRANSACTION);
				if (IsValid == false)
				{
					return;
				}
			...
			IsValid = this.dataAdapter.UniversalUpdateObject(TableNames.FirmPersonal3, "id", structureDict, this.positionID.ToString(), TransactionComnmand.USE_TRANSACTION);
			if (IsValid == false)
				return;

			IsValid = this.dataAdapter.UniversalUpdateObject(TableNames.FirmPersonal3, "id", oldStructureDict, this.oldPositionID.ToString(), TransactionComnmand.USE_TRANSACTION);
			if (IsValid == false)
				return;
			...
			if (absenceDict.Count > 0)
				this.UpdateDictToRow(absenceDict, rowH);
			this.AddDictToTable(notesDict, this.dtNotes);
			this.dateTimePickerPostypilNa.Value = this.dateTimePickerAssignedAt.Value;
			CalculatePersonalExperience();
			this.AddDictToTable(Dict, this.dtAssignment);
			//this.FixFuckedAssignmentCounters();
		...
		private void SaveEditAss()
		{
			...
			//first parse all data needed for all operations
			DataView vueAssignment = new DataView(this.dtAssignment, "id = " + this.dataGridViewAssignment.CurrentRow.Cells["id"].Value.ToString(), "id", dvrs);
			...
			{
				tesparse = int.TryParse(vueAssignment[0]["positionid"].ToString(), out this.oldPositionID);

				staff = this.getWorkTimeStaff();

				//tesparse = tesparse && double.TryParse(vueAssignment[0]["staff"].ToString(), out oldstaff);
			...
			if (tesparse == false)
			{
				MessageBox.Show("Грешка в данните за длъжност предходно назначение.", "Грешка", MessageBoxButtons.OK, MessageBoxIcon.Error);
			}
			...
			string id = this.dataGridViewAssignment.CurrentRow.Cells["id"].Value.ToString();
			IsValid = this.dataAdapter.UniversalUpdateParam(TableNames.PersonAssignment, "id", Dict, id, TransactionComnmand.BEGIN_TRANSACTION);
			if (IsValid == false)
			{
				return;
			}
			...
			this.dateTimePickerPostypilNa.Value = this.dateTimePickerAssignedAt.Value;
			CalculatePersonalExperience();
			DataRow Row = this.dtAssignment.Rows.Find(id);
			if (Row != null)
			{
		...
		private void ValidateAssignment(Dictionary<string, object> Dict)
		{
		...
		private bool CardSave()
		{
			try
			{
				...
				Dictionary<string, object> activeDict = new Dictionary<string, object>();
				Dictionary<string, object> personDict = new Dictionary<string, object>();
				result = this.ValidateCardData(Dict);
				if (result == true)
				{
					foreach (TabPage tp in this.tabControlCardNew.TabPages)
					{
		...
		private bool ValidateCardData(Dictionary<string, object> Dict)
		{
			try
			{
				Dict.Add("Parent", this.parent.ToString());
		...
		private void buttonFire_Click(object sender, System.EventArgs e)
		{
			try
			{
				if (this.dataGridViewFired.CurrentRow != null && this.dtAssignment.Rows.Count > 0)
				{
					...
					{
						DataRow rowFired = this.dtFired.Rows.Find(this.dataGridViewFired.CurrentRow.Cells["ID"].Value);

						DataView vueRel;
						DataViewRowState dvrs = DataViewRowState.CurrentRows;
						string cong = "isactive = 1";
						vueRel = new DataView(dtAssignment, cong, "id", dvrs);
						int AssignmentID = 0;
						if (vueRel != null)
						{
							try
						...
						//DataRow rowInfoPosition = this.dtAssignment.Rows[0];
						DataRow rowPosition = this.dtPosition.Rows.Find(vueRel[0]["PositionID"]);
						#region If Prowerka dali ima redowe
						if (rowPosition != null && rowFired != null && vueRel != null)
						{
							Dictionary<string, object> Dict = new Dictionary<string, object>();
							string id;
							this.ValidateFiredData(Dict);
							Dict.Add("Level1", vueRel[0]["level1"].ToString());
							Dict.Add("Level2", vueRel[0]["level2"].ToString());
							Dict.Add("Level3", vueRel[0]["level3"].ToString());
							Dict.Add("Level4", vueRel[0]["level4"].ToString());
							Dict.Add("Position", vueRel[0]["position"].ToString());
							Dict.Add("BaseSalary", vueRel[0]["basesalary"].ToString());
							id = rowFired["id"].ToString();

							/////////////////
							this.dataAdapter.UniversalUpdateParam(TableNames.Fired, "id", Dict, id, TransactionComnmand.NO_TRANSACTION);
							/////////////
							int isactive = vueRel.Count;
							if (isactive > 1)
							{
								MessageBox.Show("Служителя има повече от едно активно назначение. Моля обадете се на поддържащия персонал.");
							}

							bool iscurrent = false;
							try
							{
								iscurrent = ((string)rowPosition["TypePosition"] == "Постоянна");
							}
							catch (Exception)
							{
								iscurrent = false;
							...
							if (isactive == 1 && iscurrent) //if we have an active assignment and nonseason job
							{
								int PositionID;
								try
								{
									PositionID = int.Parse(rowPosition["ID"].ToString());
								}
								catch (System.Exception ex)
								{
									MessageBox.Show(ex.Message, "Не може да се определи идентификатора на реда на длъжността");
									PositionID = 0;
								}
								...
								Save = this.dataAdapter.UniversalUpdateParam(TableNames.Person, "id", pDict, this.parent.ToString(), TransactionComnmand.BEGIN_TRANSACTION); //update person nodeid
								if (Save == false)
								{
									MessageBox.Show("Грешка при прекратяване на договор", ErrorMessages.NoConnection);
									return;
								}
								Save = this.dataAdapter.UniversalUpdateParam(TableNames.Fired, "id", Dict, id, TransactionComnmand.USE_TRANSACTION);
								if (Save == false)
								{
									MessageBox.Show("Грешка при прекратяване на договор", ErrorMessages.NoConnection);
									return;
								}
								Save = this.dataAdapter.UniversalUpdateParam(TableNames.FirmPersonal3, "id", posDict, vueRel[0]["id"].ToString(), TransactionComnmand.COMMIT_TRANSACTION);
								if (Save == false)
								{
									MessageBox.Show("Грешка при прекратяване на договор", ErrorMessages.NoConnection);
									return;
							...
							if (iscurrent == false) //if season job
							{
								Dictionary<string, object> pDict = new Dictionary<string, object>();
								...
								pDict.Add("nodeID", "0");
								pDict.Add("fired", "1");
								iDict.Add("IsActive", "0");

								Save = this.dataAdapter.UniversalUpdateParam(TableNames.Fired, "id", Dict, id, TransactionComnmand.BEGIN_TRANSACTION);
								if (Save == false)
								{
									MessageBox.Show("Грешка при прекратяване на договор", ErrorMessages.NoConnection);
									return;
								}
								Save = this.dataAdapter.UniversalUpdateParam(TableNames.Person, "id", pDict, this.parent.ToString(), TransactionComnmand.USE_TRANSACTION);
								if (Save == false)
								{
									MessageBox.Show("Грешка при прекратяване на договор", ErrorMessages.NoConnection);
									return;
							...
							// Towa e samo kogato ima nerednost s bazata - ima samo edna naznachenie i to ne e aktino
							if (this.dtAssignment.Rows.Count == 1)
							{
								if (this.dtAssignment.Rows[0]["IsActive"].ToString() == "0") //0 because there is only one row
								{
									Dictionary<string, object> pDict = new Dictionary<string, object>();
									bool Save = false;
									pDict.Add("nodeID", "0");
									...
									Save = this.dataAdapter.UniversalUpdateParam(TableNames.Fired, "id", Dict, id, TransactionComnmand.COMMIT_TRANSACTION);
									if (Save == false)
									{
										MessageBox.Show("Грешка при прекратяване на договор", ErrorMessages.NoConnection);
										return;
						...
						#endregion
						#region Else ako nqmme nqkoy ot tezi redowe
						else
						{
							if (DialogResult.Yes == MessageBox.Show("Опитвате се да премахнете назначение което няма длъжност. Сигурни ли сте че искате да премахнете?", "Потвърждение", MessageBoxButtons.YesNo))
							{
								Dictionary<string, object> pDict = new Dictionary<string, object>();
								pDict.Add("nodeID", "0");
								this.dataAdapter.UniversalUpdateParam(TableNames.Person, "id", pDict, this.parent.ToString(), TransactionComnmand.NO_TRANSACTION);
								this.Save_Person(sender, e);
							}
						}
						#endregion
				...
				else
				{
					...
					{
						MessageBox.Show(" Не са въведени данни за прекратяване на договора");
					}
				}
				#endregion
			}
