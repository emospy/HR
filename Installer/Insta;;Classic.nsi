...
DirText "Продукта $(^Name) ще бъде инсталиран в следната директория.$\r$\n$\r$\nЗа да инсталирате в друга директория, натиснете Преглед."
...
;LicenseData "c:\path\to\licence\YourSoftwareLicence.txt"
...
Section "Main Section" SEC02
  SetOutPath "$PROGRAMFILES\Tess Partners\Human Resources\"
  SetOverwrite try
  File "..\bin\Debug\AddressInputControl.dll"
  File "..\bin\Debug\BugBox.dll"
  File "..\bin\Debug\CheckedComboBox.dll"
  File "..\bin\Debug\CheckedNumBox.dll"
  File "..\bin\Debug\CheckedTextBox.dll"
  File "..\bin\Debug\ComboBoxIntelisense.dll"
  File "..\bin\Debug\DataLayer.dll"
  File "..\bin\Debug\DataLayer.pdb"
  File "..\bin\Debug\Interop.Excel.dll"
  File "..\bin\Debug\Interop.Office.dll"
  File "..\bin\Debug\LichenSystaw2005.exe"
  File "..\bin\Debug\MySQL.Data.dll"
  CreateDirectory "$SMPROGRAMS\Човешки Ресурси"
  CreateShortCut "$SMPROGRAMS\Човешки Ресурси\Човешки Ресурси.lnk" "$PROGRAMFILES\Tess Partners\LichenSystaw2005.exe"
  CreateShortCut "$DESKTOP\Човешки Ресурси.lnk" "$PROGRAMFILES\Tess Partners\LichenSystaw2005.exe"
  File "..\bin\Debug\LichenSystaw2005.pdb"
  File "..\bin\Debug\NewTabControl.dll"
  File "..\bin\Debug\NumberBox1.dll"
  File "..\bin\Debug\PassportDataControll.dll"
  File "..\bin\Debug\System.Xml.dll"
SectionEnd
...
Section -Post
  ...
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$PROGRAMFILES\Tess Partners\LichenSystaw2005.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayName" "$(^Name)"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "UninstallString" "$INSTDIR\uninst.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$PROGRAMFILES\Tess Partners\LichenSystaw2005.exe"
...
Function un.onUninstSuccess
  HideWindow
  MessageBox MB_ICONINFORMATION|MB_OK 'Продукта "Човешки ресурси" беше премахнат от вашата система'
FunctionEnd
...
Section Uninstall
  ...
  Delete "$PROGRAMFILES\Tess Partners\System.Xml.dll"
  Delete "$PROGRAMFILES\Tess Partners\PassportDataControll.dll"
  Delete "$PROGRAMFILES\Tess Partners\NumberBox1.dll"
  Delete "$PROGRAMFILES\Tess Partners\NewTabControl.dll"
  Delete "$PROGRAMFILES\Tess Partners\LichenSystaw2005.pdb"
  Delete "$PROGRAMFILES\Tess Partners\LichenSystaw2005.exe"
  Delete "$PROGRAMFILES\Tess Partners\Interop.Office.dll"
  Delete "$PROGRAMFILES\Tess Partners\Interop.Excel.dll"
  Delete "$PROGRAMFILES\Tess Partners\DataLayer.pdb"
  Delete "$PROGRAMFILES\Tess Partners\DataLayer.dll"
  Delete "$PROGRAMFILES\Tess Partners\Config.xml"
  Delete "$PROGRAMFILES\Tess Partners\ComboBoxIntelisense.dll"
  Delete "$PROGRAMFILES\Tess Partners\CheckedTextBox.dll"
  Delete "$PROGRAMFILES\Tess Partners\CheckedNumBox.dll"
  Delete "$PROGRAMFILES\Tess Partners\CheckedComboBox.dll"
  Delete "$PROGRAMFILES\Tess Partners\BugBox.dll"
  Delete "$PROGRAMFILES\Tess Partners\AddressInputControl.dll"
  Delete "$PROGRAMFILES\Tess Partners\MySQL.Data.dll"
  ...
  RMDir "$PROGRAMFILES\Tess Partners\"
  RMDir "$PROGRAMFILES\MySQL\MySQL Server 4.1\data\hrdb"
